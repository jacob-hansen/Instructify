...
def download(cache):
    ...
    json_path = os.path.join(dataset_folder, "refcoco.json")
    filtered_data = []
...
def info():
    return {
        "name": "refcoco",
        "description": "The refcoco dataset, a large-scale visual grounding dataset.",
        "size": "22 MB",
        "num_datapoints": 48551,
        "num_images": 16994,
