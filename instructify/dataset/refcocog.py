...
def download(cache):
    ...
    dataset = load_dataset("jxu124/refcocog")

    # Extract and save only the required columns
    json_path = os.path.join(dataset_folder, "refcocog.json")
    filtered_data = []
...
def info():
    return {
        "name": "refcocog",
        "description": "The RefCOCOg dataset, a large-scale visual grounding dataset.",
        "size": "23 MB",
        "num_datapoints": 41852,
        "num_images": 21899,
